...
@php
    ...
    $sub_pagename = __('doc_setting.pagename_2');
@endphp
...
@section('content')
    <div class="pt-3">
        ...
        <form method="post" action="{{ route('setting-remark.update', ['setting_remark' => $company_id]) }}"
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="income" role="tabpanel"
                                    ...
                                    @include('company.doc_setting.remark.partials.edit_income')
                                </div>
                                <div class="tab-pane fade" id="expense" role="tabpanel" aria-labelledby="expense-tab">
                                    @include('company.doc_setting.remark.partials.edit_expense')
                                </div>
                            </div>
                        </div>
