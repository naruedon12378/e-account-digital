...
@php
    ...
    $sub_pagename = __('doc_setting.pagename_1');
@endphp
...
@section('content')
    <div class="pt-3">
        ...
        <form method="post"
            action="{{ route('setting-transaction-number.update', ['setting_transaction_number' => $company_id]) }}"
                        ...
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="income" role="tabpanel"
                                    ...
                                    @include('company.doc_setting.transaction_number.partials.edit_income')
                                </div>
                                <div class="tab-pane fade" id="expense" role="tabpanel" aria-labelledby="expense-tab">
                                    @include('company.doc_setting.transaction_number.partials.edit_expense')
                                </div>
                            </div>
                        </div>
