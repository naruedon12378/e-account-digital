...
@section('content')
    ...
    @include('components.template.common-buttons', [
        'permissions' => ['*', 'all issue_return_stock', 'create issue_return_stock'],
        'import' => [
            'url' => null,
            'isActive' => false,
        ],
        ...
        'new' => [
            'url' => 'warehouse/issuereturnstock/create',
            'id' => 'btnNewItem',
            'label' => 'Create Issue Return Stock'
        ],
        'print' => [
            'url' => null,
            'isActive' => false,
    ...
    <x-index.card>
        ...
        <div class="mb-3">
            <form id="frmIndex" class="form-inline" action="{{ route('issuereturnstock.index') }}">
