                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control " name="lot_number" id="lot_number"
                                    min="0" placeholder="0" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control " name="used_amount" id="used_amount"
                                    min="0" placeholder="0" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control " name="remaining_amount"
                                    id="remaining_amount" min="0" placeholder="0" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label class="form-label">{{ __('inventory_stock.coust_price') }}</label>
                                <input type="number" class="form-control " name="coust_price" id="coust_price"
                                    min="0" placeholder="0" />
                            </div>
                        </div>
                        <div class="col-sm-12">
