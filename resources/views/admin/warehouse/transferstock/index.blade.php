...
@section('content')
    ...
    @include('components.template.common-buttons', [
        'permissions' => ['*', 'all transfer_stock', 'create transfer_stock'],
        'import' => [
            'url' => null,
            'isActive' => false,
        ],
        ...
        'new' => [
            'url' => 'warehouse/transferstock/create',
            'id' => 'btnNewItem',
            'label' => 'Create Transfer Stock'
        ],
        'print' => [
            'url' => null,
            'isActive' => false,
    ...
    <x-index.card>
        ...
        <div class="mb-3">
            <form id="frmIndex" class="form-inline" action="{{ route('transferstock.index') }}">
