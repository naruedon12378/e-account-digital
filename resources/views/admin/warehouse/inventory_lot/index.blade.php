...
@php $pagename = 'รายการปรับแก้ล็อตสินค้า'; @endphp
            ...
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="col-8 d-flex justify-content-end">
                        ...
                        @if (Auth::user()->hasAnyPermission(['*', 'all inventory_lot', 'create inventory_lot']))
                            <div class="ml-4">
                                <a class="btn {{ env('BTN_OUTLINE_THEME') }} mb-2" onclick="addStorck()">
                                    <!-- <i class="fas fa-arrow-right-arrow-left fa-rotate-90 mr-2"></i> -->
                                    <i class="fas fa-plus mr-2"></i>
                                    {{ __('inventory_lot.add_product_lot') }}
                                </a>
                            </div>
                        @endif
                    </div>
                ...
                <table id="table" class="table table-hover dataTable no-footer nowrap" style="width: 100%;">
                    <thead class="bg-custom">
                        <tr>
                            ...
                            <th class="text-center">{{ __('inventory_lot.lot_number') }}</th>
                            <th class="text-center">{{ __('inventory_lot.product_quantity') }}</th>
                            <th class="text-center">{{ __('inventory_lot.import_date') }}</th>
                            <th class="text-center">{{ __('inventory_lot.adjustment_count') }}</th>
    ...
    @push('js')
        <script>
            ...
            function addStorck(){
                ...
                let url = "{{ route('inventorylot.create') }}";
                if( warehouse_id>=1 ){
                    url = "{{ route('inventorylot.create', ['whid' => ':id']) }}";
