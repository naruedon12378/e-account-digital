            ...
            <div class="card-body">
                ...
                @if (Auth::user()->hasAnyPermission(['*', 'all role', 'create role']))
                    <div class="text-right">
                        <a href="{{ route('role.create') }}" class="btn {{ env('BTN_OUTLINE_THEME') }} mb-2"><i
                ...
                <table id="table" class="table table-hover dataTable no-footer nowrap" style="width: 100%;">
                    <thead class="bg-custom">
                        <tr>
                            <th class="text-center" style="width: 10%">{{ __('role.number') }}</th>
                            <th class="text-center">{{ __('role.role') }}</th>
                            <th class="text-center">{{ __('role.description') }}</th>
                            <th class="text-center" style="width: 10%">{{ __('role.actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
