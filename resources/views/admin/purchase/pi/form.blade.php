<x-form name="frmExpense" :action="$purchase->id ? route('purchase_invoices.update', $purchase->id) : route('purchase_invoices.store')" enctype>
    ...
    <div class="text-center mt-5">
        <x-button-cancel url="{{ route('purchase_invoices.index') }}">
            {{ __('file.Cancel') }}
        </x-button-cancel>
        ...
        <x-button-group label="Approve Purchase Inventory" color="info">
            <a class="dropdown-item" href="javascript:;">
                Approve and print
            </a>
            <a class="dropdown-item" href="javascript:;">
