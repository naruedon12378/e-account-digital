<x-form name="frmExpense" :action="$purchase->id ? route('purchase_asset_orders.update', $purchase->id) : route('purchase_asset_orders.store')" enctype>
    ...
    <div class="text-center mt-5">
        <x-button-cancel url="{{ route('purchase_asset_orders.index') }}">
            {{ __('file.Cancel') }}
        </x-button-cancel>
        ...
        <x-button-group label="Approve Purchase Asset Order" color="info">
            <a class="dropdown-item" href="javascript:;">
                Approve and print
            </a>
            <a class="dropdown-item" href="javascript:;">
