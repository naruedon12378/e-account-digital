<x-form name="frmPurchase" :action="$purchase->id ? route('expenses.update', $purchase->id) : route('expenses.store')" enctype>
    ...
    <div class="text-center mt-5">
        <x-button-cancel url="{{ route('expenses.index') }}">
            {{ __('file.Cancel') }}
        </x-button-cancel>
        ...
        <x-button-group label="Approve Expense Record" color="info">
            <a class="dropdown-item" href="javascript:;">
                Approve and print
            </a>
            <a class="dropdown-item" href="javascript:;">
