        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">{{ __('uploadDocument.upload_document_file') }}
                    </h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="icheck-primary icheck-inline">
                                <input type="radio" id="chb1" name="doc_type" value="expenses" checked />
                                <label for="chb1">{{ __('uploadDocument.expenses') }}</label>
                            </div>
                            <div class="icheck-primary icheck-inline">
                                <input type="radio" id="chb2" name="doc_type" value="revenues" />
                                <label for="chb2">{{ __('uploadDocument.revenues') }}</label>
                            </div>
                            <div class="icheck-primary icheck-inline">
                                <input type="radio" id="chb3" name="doc_type" value="withheld_tax" />
                                <label for="chb3">{{ __('uploadDocument.withheld_tax') }}</label>
                            </div>
                            <div class="icheck-primary icheck-inline">
                                <input type="radio" id="chb4" name="doc_type" value="unspecified" />
...
@push('js')
    <script>
        ...
        function chkDocType() {
            type = $("input[name='doc_type']:checked").val();
            if (type == 'expenses') {
