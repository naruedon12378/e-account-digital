            ...
            <div class="card {{ env('CARD_THEME') }} card-outline">
                <div class="card-header" style="font-size: 20px;">
                    ...
                    @if (Auth::user()->id != $member->id)
                        <a class="btn btn-outline-danger" id="disable_user"> <i
                                class="fas fa-trash mr-2"></i>{{ __('member.delete_member') }}</a>
                    @endif
                </div>
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control  inputmask-phone"
                                                        ...
                                                        @if ($key)
                                                            ...
                                                            @foreach ($group_permission as $permission)
                                                                @if ($permission->group_en == $key || $permission->group_th == $key)
                                                                    <td style="width: 5%;">
                                                                        <label class="switch2 mr-2"> <input
                                                                                type="checkbox"
                                                                                value="{{ $permission->id }}"
                                                                                id="" name="permissions[]"
                                                                                {{ in_array($permission->name, $member->getPermissionNames()->ToArray()) ? 'checked' : '' }}>
                                ...
                                @if (!$key)
                                    <div class="card card-default mt-3">
                                        <div class="card-header">
                                            <h3 class="card-title">{{ $key ? $key : __('member.other') }}</h3>
