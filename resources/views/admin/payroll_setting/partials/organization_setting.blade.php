<div class="card shadow-custom general-input">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="mb-3">
                    ...
                    <input disabled type="text" id="tax_number" name="tax_number" class="form-control"
                        value="{{ @$data->tax_number }}">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="icheck-primary icheck-inline mb-3">
                    <input disabled type="radio" name="branch" value="0" id="head_office_chkbox"
                        {{ $data->branch == 0 ? 'checked' : '' }} />
                    <label for="head_office_chkbox">{{ __('payroll_setting.head_office') }}</label>
                </div>
                <div class="icheck-primary icheck-inline mb-3">
                    <input disabled type="radio" name="branch" value="1" id="branch_no_chkbox"
            ...
            <div class="col-sm-6 mb-3 branch-section">
                ...
                <input disabled type="text" name="branch_name" id="branch_name" value="{{ @$data->branch_name }}"
                    class="form-control">
            </div>
            <div class="col-sm-6 mb-3 branch-section">
                <label for="">{{ __('payroll_setting.branch_no') }}</label>
                <input disabled type="text" name="branch_no" id="branch_no" value="{{ @$data->branch_no }}"
                    class="form-control">
            </div>
            <div class="col-sm-6">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.organization_from') }}</label>
                    <select disabled name="category_business_id" id="category_business_id" class="form-control select2"
                        style="width: 100%;">
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <select disabled name="type_business_id" id="type_business_id" class="form-control select2"
                        style="width: 100%;">
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" id="name_th" name="name_th" class="form-control"
                        value="{{ @$data->name_th }}">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" id="name_en" name="name_en" class="form-control"
                        value="{{ @$data->name_en }}">
                </div>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control input disabledmask-phone" id="phone"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control" id="fax_number" name="fax_number"
            ...
            <div class="col-sm-12">
                <div class="mb-3">
                    ...
                    <textarea disabled class="form-control" rows="3" id="detail_th" name="detail_th">{{ $data->company_address->detail_th }}</textarea>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.sub_district') }}</label>
                    <input disabled type="text" class="form-control" id="sub_district_th" name="sub_district_th"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control" id="district_th" name="district_th"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control" id="province_th" name="province_th"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="postcode form-control" oninput disabled="mirror(this)"
                        id="postcode" name="postcode" value="{{ @$data->company_address->postcode }}">
                </div>
            </div>
            <div class="col-sm-12 mb-3">
                <blockquote class="quote-success text-md" style="margin: 0 !important;">
            ...
            <div class="col-sm-12">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.address') }}</label>
                    <textarea disabled class="form-control" rows="3" id="detail_en" name="detail_en">{{ @$data->company_address->detail_en }}</textarea>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.sub_district') }}</label>
                    <input disabled type="text" class="form-control" id="sub_district_en" name="sub_district_en"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.district') }}</label>
                    <input disabled type="text" class="form-control" id="district_en" name="district_en"
            ...
            <div class="col-sm-6">
                <div class="mb-3">
                    <label for="">{{ __('payroll_setting.province') }}</label>
                    <input disabled type="text" class="form-control" id="province_en" name="province_en"
