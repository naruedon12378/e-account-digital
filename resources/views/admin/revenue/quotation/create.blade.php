...
@section('content')
    ...
    <x-form-card>
        <x-form name="frmQuotation" 
            :action="$quotation->id ? route('quotations.update', $quotation->id) : route('quotations.store')" enctype>
                ...
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <x-form-group label="quotation.reference" name="reference" value="{{ $quotation->reference }}">
                            </x-form-group>
                        </div>
                        <div class="col-12 col-md-6">
