...
@php
    $pagename = [
        'th' => 'แก้ไขข้อมูลรายการ',
        'en' => 'Edit Payroll Salary',
    ];
...
@section('content')
    <div class="pt-3">
        ...
        <form method="post" action="{{ route('payroll_salary.update', ['payroll_salary' => $payroll_salary['id']]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3 text-right">
                                    <input name="company_social_security" style="width: 150px" type="number"
                                        ...
                                        class="form-control text-right w-100 numberInputEmpSocial company_social_security">
                                </div>
                                <div class="col-sm-6 mb-3 text-right">
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            var currentDate = "{{ date_format(date_create($payroll_salary->issue_date), 'd/m/Y') }}";
            var dueDate = "{{ date_format(date_create($payroll_salary->due_date), 'd/m/Y') }}";
            var firstDate = "{{ date_format(date_create($payroll_salary->from_date), 'd/m/Y') }}";
            var endDate = "{{ date_format(date_create($payroll_salary->to_date), 'd/m/Y') }}";
        ...
        function constructData() {
            ...
            $('.company_social_security').val(company_social_security)
            ...
            $.each(payrollSalaryDetail, function(index, employee) {
                ...
                $.each(employee['payroll_salary_more_details'], function(key, record) {
                    ...
                    var inputElement = `
                                            <td>
                                                <input name="frecord_${key}[]" style="width: 150px"
                                                    type="number" step="0.01" value="${record['value']}"
                ...
                var newRowHtml = `
                                                <tr>
                                                    <td>
                                                        <select name="employee[]" class="form-control select2 old-data" style="width: 250px">
                                                            <option value="${employee['employee']['id']}"
                                                                data-salary="${employee['employee']['salary']}" data-social_security_status="${employee['employee']['scc_chkbox']}">${employee['employee']['fullname']['{{ $name }}']}
                                                            </option>
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <input name="salary[]" style="width: 150px" type="number" step="0.01"
                                                            value="${employee['salary']}" class="form-control text-right numberInput calAdd">
                                                    </td>
                                                    ${dynamicRecords}
                                                    <td>
                                                        <input name="withholding_tax[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['withholding_tax']}"
                                                            class="form-control text-right numberInput calCut">
                                                    </td>
                                                    <td>
                                                        <input name="social_security[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['social_security']}"
                                                            max="{{ $company_setting->employees_maximum_amount }}"
                                                            class="form-control text-right numberInput calCut">
                                                    </td>
                                                    <td>
                                                        <input name="pvd[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['pvd']}"
                                                            max="{{ $company_setting->employees_maximum_amount }}"
                                                            class="form-control text-right numberInput calCut">
                                                    </td>
                                                    <td>
                                                        <input name="total_revenue[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['total_revenue']}"
                                                            class="form-control text-right numberInput sumAdd">
                                                    </td>
                                                    <td>
                                                        <input name="total_deduct[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['total_deduct']}"
                                                            class="form-control text-right numberInput sumCut">
                                                    </td>
                                                    <td>
                                                        <input name="net_salary[]" style="width: 150px" type="number"
                                                            step="0.01" value="${employee['net_salary']}"
                                                            class="form-control text-right numberInput calTotal">
                                                    </td>
                                                    <td><a class="btn btn-danger removeitem"><i class="fas fa-trash-alt"></i></a></td>
                                                </tr>
