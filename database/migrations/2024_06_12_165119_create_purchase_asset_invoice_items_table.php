...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_asset_invoice_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('purchase_asset_invoice_id');
    ...
    {
        Schema::dropIfExists('purchase_asset_invoice_items');
    }
};
