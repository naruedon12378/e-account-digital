...
return new class extends Migration
{
   public function up(): void
    {
        Schema::create('issue_return_stock_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('issue_return_stock_id');
    ...
    {
        Schema::dropIfExists('issue_return_stock_items');
    }
};
