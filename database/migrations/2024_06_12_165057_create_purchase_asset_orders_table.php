...
return new class extends Migration
{
    ...
    {
        Schema::create('purchase_asset_orders', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status_code', ['draft', 'await_approval', 'approved', 'voided']);
            $table->enum('progress', ['pao','pi', 'pv']);
    ...
    {
        Schema::dropIfExists('purchase_asset_orders');
    }
};
