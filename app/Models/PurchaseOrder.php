...
class PurchaseOrder extends Model
{
    ...
    public function getActiveStyleAttribute()
    {
        $isActive = view('components.index.table-status', [
            'role' => 'user',
            'url' => 'purchase_ledger/purchase_orders/toggle_active/' . $this->id,
            'data' => [
                'id' => $this->id,
    ...
    public function getEditLinkAttribute()
    {
        $btnEdit = view('components.index.edit-link', [
            ...
            'url' => $this->status_code == 'draft' 
                    ? 'purchase_ledger/purchase_orders/' . $this->id . '/edit' 
                    : 'purchase_ledger/purchase_orders/' . $this->id,
    ...
    public function getBtnEditAttribute()
    {
        $btnEdit = view('components.index.table-edit', [
            'permissions' => ['*', 'all po', 'edit po'],
            'url' => 'purchase_ledger/purchase_orders/' . $this->id . '/edit',
            'id' => $this->id,
        ]);
    ...
    public function getBtnDeleteAttribute()
    {
        $btnDelete = view('components.index.table-delete', [
            ...
            'url' => 'purchase_ledger/purchase_orders/' . $this->id,
        ]);
