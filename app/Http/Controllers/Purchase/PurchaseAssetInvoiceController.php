...
class PurchaseAssetInvoiceController extends Controller
{
    ...
    public function __construct(FileUploadService $fileUpload, PurchaseService $purchase)
    {
        ...
        $this->trxType = TransactionEnum::purchaseAsset->value;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.purchase.pai.index', compact('tabs', 'status', 'fromDate', 'toDate'));
    }
    ...
    {
        $purchase = new PurchaseAssetInvoice();
        $purchase->doc_number = "PA-20240600001";

        return view('admin.purchase.pai.create', compact('purchase'));
    }
    ...
    public function store(PurchaseRequest $request)
    {
        $validator = Validator::make($request->all(), [
            'doc_number' => 'unique:purchase_asset_invoices'
        ]);
        if ($validator->fails()) {
        ...
        $redirect = route('purchase_asset_invoices.index');
    ...
    public function show(string $id)
    {
        ...
        return view('admin.purchase.pai.details', compact('purchase', 'items','tabs', 'histories'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.purchase.pai.create', compact('purchase', 'items','tabs', 'histories'));
    }
